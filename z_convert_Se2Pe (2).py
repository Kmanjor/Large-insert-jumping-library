...
f_left_sam = open('./data_test7/gu_yu18_left_mmi_q60F2048_Abb.sam', 'r')
...
f_left_sam.close()
f_right_sam = open('./data_test7/gu_yu18_right_mmi_q60F2048_Abb.sam', 'r')
...
f_bed_left = open('./data_test7/gu_yu18_left_mmi_q60F2048.bed', 'r')
...
f_bed_left.close()
f_bed_right = open('./data_test7/gu_yu18_right_mmi_q60F2048.bed', 'r')
...
# 输出newform验证。
f_shuchu = open('./data_test7/gu_yu18_mmi_q60F2048.newform', 'w')
